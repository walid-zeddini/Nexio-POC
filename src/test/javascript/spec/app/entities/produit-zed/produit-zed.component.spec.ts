...
import { ProduitZedComponent } from 'app/entities/produit-zed/produit-zed.component';
...
describe('Component Tests', () => {
  describe('ProduitZed Management Component', () => {
    let comp: ProduitZedComponent;
    let fixture: ComponentFixture<ProduitZedComponent>;
    let service: ProduitZedService;

    beforeEach(() => {
      TestBed.configureTestingModule({
        imports: [NexioTestModule],
        declarations: [ProduitZedComponent],
        providers: [
          {
        ...
        .overrideTemplate(ProduitZedComponent, '')
        .compileComponents();

      fixture = TestBed.createComponent(ProduitZedComponent);
