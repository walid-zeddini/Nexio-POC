...
@RestController
@RequestMapping("/api/nexio-kafka")
public class NexioKafkaResource {

    private final Logger log = LoggerFactory.getLogger(NexioKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public NexioKafkaResource(KafkaProperties kafkaProperties) {
